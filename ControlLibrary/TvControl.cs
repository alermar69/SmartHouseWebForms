...
{
    public class TvControl : CompositeControl
    {
        ...
        private VolumeContol _volume;

        private DataForControl _data;
        private DeviceControl _device;

        public TvControl(DataForControl data)
        {
            _data = data;
        ...
        private void CreateControls()
        {
            ...
            _volume = new VolumeContol(_data);
        ...
        private void SetImageUrl()
        {
            if (_data.Device.State == StateOnOff.Off)
            {
                ...
                _image.ImageUrl = "~/Images/television.png";
            }
            else
            {
                _imBt.ImageUrl = "~/Images/control_power_blue.png";
                _image.ImageUrl = "~/Images/932273044.gif";
            }
        }
    }
}
